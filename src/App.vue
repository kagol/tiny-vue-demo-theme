...
const isIndeterminate = computed({
  get() {
    return (
      ...
      checkboxGroup.value.length !== cities.value.length
    );
  },
});
...
let validatePass = (rule, value, callback) => {
  if (!/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,}$/.test(value)) {
    callback(
      new Error("最少八个字符，至少包含一个大写字母，一个小写字母和一个数字")
    );
  } else {
    callback();
  }
    ...
    children: [
      {
        id: "1-1",
        label: "数据 1-1",
        children: [{ id: "1-1-1", label: "数据 1-1-1" }],
      },
      { id: "1-2", label: "数据 1-2" },
    ],
  },
...
<template>
  ...
  <tiny-layout>
          ...
          <tiny-row>
            ...
            <tiny-col :span="6">
              ...
              <div class="block dialog-box">
                <tiny-button @click="boxVisibility = true" title="弹出 Dialog"
                  >弹出 Dialog</tiny-button
                >
                <tiny-dialog-box
                ...
                >
                  ...
                  <template #footer>
                    ...
                    <tiny-button @click="boxVisibility = false">
                      取消
                    </tiny-button>
                  </template>
                </tiny-dialog-box>
    ...
    <tiny-row>
      ...
      <tiny-col :span="4">
        <div class="block cascader" style="margin-bottom: 230px;">
          <tiny-cascader
